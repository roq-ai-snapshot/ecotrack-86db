...
import { getSustainabilityInitiativeById } from 'apiSdk/sustainability-initiatives';
...
function SustainabilityInitiativeViewPage() {
  ...
  return (
    <AppLayout>
      <Text as="h1" fontSize="2xl" fontWeight="bold">
        Sustainability Initiative Detail View
      </Text>
...
})(SustainabilityInitiativeViewPage);
